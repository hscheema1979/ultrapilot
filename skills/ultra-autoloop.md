...
```bash
# Start the domain heartbeat driver
/ultra-autoloop

# Start with custom cycle time
/ultra-autoloop --cycle 30s    # Check every 30 seconds
/ultra-autoloop --cycle 5m     # Check every 5 minutes

# Start with specific focus
/ultra-autoloop --focus tasks      # Focus on task processing
/ultra-autoloop --focus sync       # Focus on domain sync
/ultra-autoloop --focus health     # Focus on health monitoring

# Stop the heartbeat (ONLY way to stop)

...
add_columns "hscheema1979" "myhealthteam" "MyHealthTeam Platform \
  ...
  "⚙️ Development|Active development sprints" \
...
add_columns "hscheema1979" "ultrapilot" "UltraPilot Development" \
  ...
  "⚙️ In Progress|Phase 2: Execution" \
  "🧪 QA|Phase 3: QA Cycles" \
  "✔️ Validation|Phase 4: Multi-Perspective Validation" \
...
add_columns "hscheema1979" "ultrapilot" "Mission Control" \
  ...
  "🖥️ Frontend|Frontend components and views" \
...
echo ""
echo "1️⃣  MyHealthTeam Platform:"
echo "   https://github.com/hscheema1979/myhealthteam/projects"
echo ""
echo "2️⃣  UltraPilot Development:"
echo "   https://github.com/hscheema1979/ultrapilot/projects"
echo ""
echo "3️⃣  Mission Control:"
echo "   https://github.com/hscheema1979/ultrapilot/projects"
echo "   Same as UltraPilot, just a different project board"
echo ""

...
- **From**: `/tmp/agents-lib/plugins/`
- **To**: `/home/ubuntu/hscheema1979/ultrapilot/agents-lib/plugins/`
...
- **Updated**: Default path changed from `/tmp/agents-lib/plugins` to `./agents-lib/plugins`
...
│       │   └── in-memory.ts
│       └── scanner.ts
├── agents-lib/           # ✅ NOW IN REPO (113 agents)
...
Scanning: /home/ubuntu/hscheema1979/ultrapilot/agents-lib/plugins
...
// Create repository
const repo = await createInMemoryRepository('./agents-lib/plugins');
...
✅ **113 specialist agents available** in agents-lib/plugins/
